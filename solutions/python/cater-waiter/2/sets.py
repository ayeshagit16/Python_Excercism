...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for name, ingredient_set in category_map.items():
        if dish_ingredients.issubset(ingredient_set):
...
def tag_special_ingredients(dish):
    ...
    special_note_set = SPECIAL_INGREDIENTS.intersection(ingredients_list)
    return (dish_name, special_note_set)
